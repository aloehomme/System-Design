...
УПРОЩЕНИЕ: дозапись в локальный файл JSON Lines. В целевой системе - Kafka
как транспорт, ClickHouse для аналитики и S3 с Object Lock как неизменяемая
копия на 3 года (docs/architecture.md, раздел 6).
"""
