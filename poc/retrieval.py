...
УПРОЩЕНИЕ: линейный перебор 10 статей базы знаний и 15 прошлых тикетов по
TF-IDF. В целевой системе - ANN-поиск (Approximate Nearest Neighbours) по
эмбеддингам multilingual-e5-small в векторной базе (Qdrant / pgvector),
с отдельными пространствами имён для статей и тикетов.
"""
